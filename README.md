...
- [`error-injection`](https://github.com/eunomia-bpf/bpftime/tree/master/example/error-inject) Inject errors into a userspace functions or syscalls to test its error handling capabilities.
