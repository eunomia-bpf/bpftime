...
static long (*io_uring_init_global)(void) = (void *) EXTENDED_UFUNC_IOURING_INIT;
static long (*io_uring_submit_write)(int fd, char *buf, unsigned long long size) = (void *) EXTENDED_UFUNC_IOURING_SUBMIT_WRITE;
static long (*io_uring_submit_fsync)(int fd) = (void *) EXTENDED_UFUNC_IOURING_SUBMIT_FSYNC;
static long (*io_uring_wait_and_seen)(void) = (void *) EXTENDED_UFUNC_IOURING_WAIT_AND_SEEN;
