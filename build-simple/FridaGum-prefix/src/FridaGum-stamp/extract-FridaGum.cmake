...
#
get_filename_component(filename "/home/runner/work/bpftime/bpftime/third_party/frida/frida-gum-devkit-16.1.2-linux-x86_64.tar.xz" ABSOLUTE)
get_filename_component(directory "/home/runner/work/bpftime/bpftime/build-simple/FridaGum-prefix/src/FridaGum" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-FridaGum${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-FridaGum${i}")
