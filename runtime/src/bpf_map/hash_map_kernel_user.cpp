...
namespace bpftime
{
hash_map_kernel_user_impl::hash_map_kernel_user_impl(managed_shared_memory &memory, uint32_t key_size,
			     uint32_t value_size)
...
int hash_map_kernel_user_impl::bpf_map_get_next_key(const void *key, void *next_key)
{
	if (key == nullptr) {
