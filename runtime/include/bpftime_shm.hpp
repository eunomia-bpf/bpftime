...
enum class bpf_map_type {
	...
	BPF_MAP_TYPE_KERNEL_USER_PROG_ARRAY =
		KERNEL_USER_MAP_OFFSET + BPF_MAP_TYPE_PROG_ARRAY,
	...
	BPF_MAP_TYPE_KERNEL_USER_LRU_HASH =
		KERNEL_USER_MAP_OFFSET + BPF_MAP_TYPE_LRU_HASH,
	BPF_MAP_TYPE_KERNEL_USER_LPM_TRIE =
		KERNEL_USER_MAP_OFFSET + BPF_MAP_TYPE_LPM_TRIE,
