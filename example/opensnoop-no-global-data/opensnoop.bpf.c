...
#define targ_pid ((pid_t)0)
#define targ_tgid ((pid_t)0)
#define targ_uid ((uid_t)0)
#define targ_failed ((bool)false)
// const pid_t targ_pid = 0;
// const pid_t targ_tgid = 0;
// const uid_t targ_uid = 0;
// const bool targ_failed = false;
